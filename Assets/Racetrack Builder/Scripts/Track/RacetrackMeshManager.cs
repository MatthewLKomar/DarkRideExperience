...
public class RacetrackMeshManager : MonoBehaviour
{
    ...
    public static HashMethod GetHashMethod()
    {
        ...
        return meshManager != null ? meshManager.HashMethod : HashMethod.MD5;
    }
    ...
    private HashMethod HashMethod
    {
        get
        {
            // If SavedMeshes is present, use its value. Otherwise default to MD5
            return SavedMeshes != null ? SavedMeshes.HashMethod : HashMethod.MD5;
        }
    }
}
